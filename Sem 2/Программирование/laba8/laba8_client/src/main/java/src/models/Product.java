...
public class Product implements Serializable {
     ...
     * @param manufactureCost the manufacture cost
     * @param unitOfMeasure   the unit of measure
     * @param user            the user who insert this product in collection
     */
    public Product(Long id, String name, Coordinates coordinates, int price, Person owner, Integer manufactureCost, UnitOfMeasure unitOfMeasure, User user) {
        this(id, name, coordinates, price, owner, manufactureCost, unitOfMeasure);
        this.user = user;
    }
    ...
    public boolean equals(Object o) {
        ...
        return price == product.price && Objects.equals(user, product.user) && Objects.equals(id, product.id) && Objects.equals(name, product.name) && Objects.equals(coordinates, product.coordinates) && Objects.equals(creationDate, product.creationDate) && Objects.equals(manufactureCost, product.manufactureCost) && unitOfMeasure == product.unitOfMeasure && Objects.equals(owner, product.owner);
    }

    @Override
    public int hashCode() {
        return Objects.hash(user, id, name, coordinates, creationDate, price, manufactureCost, unitOfMeasure, owner);
    }
}
