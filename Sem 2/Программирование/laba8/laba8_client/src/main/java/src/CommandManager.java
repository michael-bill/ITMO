...
public class CommandManager {
    ...
    public void auth(String login, String password) throws ServerRuntimeException {
    ...
    public void register(String login, String password) throws ServerRuntimeException {
        UserCredentials credentials = new UserCredentials(login, password);
